 ...
 */
export const getApiNodesMatrixByMatrixId = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetApiNodesMatrixByMatrixIdData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiNodesMatrixByMatrixIdResponse, GetApiNodesMatrixByMatrixIdError, ThrowOnError>({
        ...options,
        url: '/api/nodes/matrix/{matrixId}'
    });
};
 ...
 * Get all nodes
 */
export const getApiNodes = <ThrowOnError extends boolean = false>(options?: OptionsLegacyParser<unknown, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiNodesResponse, GetApiNodesError, ThrowOnError>({
        ...options,
        url: '/api/nodes'
    });
};
 ...
 * Create a new node
 */
export const postApiNodesMatrixByMatrixIdNodes = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PostApiNodesMatrixByMatrixIdNodesData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiNodesMatrixByMatrixIdNodesResponse, PostApiNodesMatrixByMatrixIdNodesError, ThrowOnError>({
        ...options,
        url: '/api/nodes/matrix/{matrixId}/nodes'
    });
};
