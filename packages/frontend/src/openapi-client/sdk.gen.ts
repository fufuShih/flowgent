 ...
 */
export const getApiProjectByProjectIdMatrix = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<GetApiProjectByProjectIdMatrixData, ThrowOnError>) => {
    return (options?.client ?? client).get<GetApiProjectByProjectIdMatrixResponse, GetApiProjectByProjectIdMatrixError, ThrowOnError>({
        ...options,
        url: '/api/project/{projectId}/matrix'
    });
};
 ...
 * Create a new matrix
 */
export const postApiProjectByProjectIdMatrix = <ThrowOnError extends boolean = false>(options: OptionsLegacyParser<PostApiProjectByProjectIdMatrixData, ThrowOnError>) => {
    return (options?.client ?? client).post<PostApiProjectByProjectIdMatrixResponse, PostApiProjectByProjectIdMatrixError, ThrowOnError>({
        ...options,
        url: '/api/project/{projectId}/matrix'
    });
};
